...
const FlightTabRoundTrip = ({ onView }) => {
  ...
  const table_heading = useMemo(
    () => ({
      heading: "Round-trip bookings",
      para: rows.length
        ? "Browse and manage your round trips."
        : "No Data Found",
    }),
    [rows.length]
  );
    ...
    (async () => {
      ...
      try {
        ...
        const filtered = docs.filter(
          (d) => normalizeJourneyType(d?.journey_type) === "ROUNDTRIP"
        );
...
export default FlightTabRoundTrip;
