    ...
    >
      <Toolbar>
        ...
        <Box display="flex" alignItems="center">
          ...
          {/* Avatar */}
          <IconButton sx={{ color: "black" }} id="basic-button"
          ...
          >
            <MenuItem onClick={() => { return (navigate('/dashboard/profile'), handleClose()) }} sx={{ fontSize: "15px" }}><AccountCircleIcon sx={{ marginRight: "10px" }} />Profile</MenuItem>
            <MenuItem onClick={handleLogout} sx={{ fontSize: "15px" }}><LogoutIcon sx={{ marginRight: "10px" }} />Logout</MenuItem>
          </Menu>
        </Box>
      </Toolbar>
    </AppBar>
